    ...
    "@graph": [
      {
        ...
        description:
          "AI-powered trading risk management and behavioral analytics platform",
        sameAs: [
      ...
      },
      {
        ...
        operatingSystem: "Web",
        description:
          "AI trading risk management platform that analyzes behavioral patterns and provides real-time guidance",
        offers: {
          "@type": "Offer",
          price: "0",
          priceCurrency: "USD",
